...
export default function HeroSection() {
    ...
    // 이미지 밝기에 따른 텍스트 색깔 자동조정 로직 (브라우저 전용)
    ...
    // 하이드레이션 에러 방지: 마운트 전에는 정적인 기본 구조만 렌더링
    if (!isMounted) {
        return <div className="w-full h-96 bg-muted animate-pulse rounded-3xl" />;
    }
        ...
        <>
            <div className="w-full overflow-hidden rounded-3xl relative">
                ...
                >
                        ...
                        {notices.map((notice, index) => (
                            <CarouselItem key={index} className="relative justify-center items-center pl-0">
                                <div
                                    ...
                                    } lg:ml-36 md:ml-32 ml-20 h-full flex flex-col justify-center md:bottom-6 z-10`}
                                >
                    ...
                    <div className="absolute lg:ml-32 md:ml-26 ml-16 text-neutral-400 border border-neutral-400 rounded-full px-8 py-0.5 lg:bottom-22 bottom-18 not-md:hidden z-20">
