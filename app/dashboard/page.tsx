...
export default function Register() {
    ...
    const initUser = async () => {
        ...
        if (!session.data.session?.user && !data) {
        ...
        return (
            <div className="max-w-lg mx-auto px-5">
                ...
                <form
                    ...
                    className="space-y-8 [&_li]:space-y-2 list-none [&_p]:flex [&_p]:items-center [&_p]:space-x-2.5 [&_input]:text-sm [&_span]:text-xs mt-12"
                >
                    <li>
                        {/* 이름은 임의로 수정할 수 없다. */}
                        <p>
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>이름은 수정할 수 없습니다.</TooltipContent>
                        </Tooltip>
                    </li>
                    <li>
                        <p>
                        ...
                        <Tooltip>
                            <TooltipTrigger className="w-full">
                                <InputOTP value={`${studentId}`} disabled maxLength={8}>
                                    <InputOTPGroup>
                                        <InputOTPSlot key={7} index={0} />
                            ...
                            <TooltipContent>학번은 수정할 수 없습니다.</TooltipContent>
                        </Tooltip>
                    </li>
                    <li>
                        <p>
